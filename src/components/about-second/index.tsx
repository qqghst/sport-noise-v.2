    ...
    return (
        <section
            ...
            <div className=''>
                ...
                <p
                    ref={aboutSecondRef}
                    className='text-[18px] sm:text-[21px] lg:text-[28px] xl:text-[37px] tracking-[-0.5px] xl:tracking-[-0.2px] leading-[30px] lg:leading-[38px] xl:leading-[52px] font-medium text-black w-full sm:w-[90%] xl:w-[80%]'>
