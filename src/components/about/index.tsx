        ...
        <section className='bg-white mb-[48px] md:mb-[106px] px-5 md:px-[64px] lg:px-[128px]'>
            <div className='about-container'>
                <p
                    ...
                    Здесь будет манифест, в который описывает главные выгоды и
                    пользу для бизнеса клиента. Манифест не содержит информации
                    о услугах и о нас. Данный текст показывает примерный объем
                    текста, чтобы не много не перегрузить.
                </p>
            </div>
        </section>
    );
