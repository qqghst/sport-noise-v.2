    ...
    return (
        <section className='bg-white mb-[48px] md:mb-[106px] px-5 md:px-[64px] lg:px-[128px]'>
            <div className='about-container'>
                <p
                    ref={refAbout}
                    className='text-[18px] sm:text-[21px] lg:text-[28px] xl:text-[37px] tracking-[-0.5px] xl:tracking-[-0.2px] leading-[30px] lg:leading-[38px] xl:leading-[52px] font-medium text-black w-full sm:w-[90%] md:w-[85%] lg:w-[92%] xl:w-[98%]'>
