...
import { CursorContext } from './cursor-manager';
...
const CustomCursor = ({ speed = 0.1 }) => {
    ...
    return (
        <div className={`secondaryCursor ${size}`} ref={mainCursor}>
            <span>
                {size === 'big' ? <Image src={arrow} alt='arrow' width={48 / 2} height={48 / 2} className='text-[#324590] -rotate-45' /> : ''}
            </span>
        </div>
    );
};
